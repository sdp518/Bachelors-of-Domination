...
public class Map{
    ...
    public Map() {
        ...
        // halifax
        this.sectors.put(4, new Sector(4, -1, "Halifax 1", 0, 2, new int[]{}, new Texture("halifax1.png"), new Pixmap(Gdx.files.internal("halifax1.png")), "halifax1.png", 0, 0, false));
        this.sectors.put(5, new Sector(5, -1, "Halifax 2", 0, 2, new int[]{}, new Texture("halifax2.png"), new Pixmap(Gdx.files.internal("halifax2.png")), "halifax2.png", 0, 0, false));
        this.sectors.put(6, new Sector(6, -1, "Halifax 3", 0, 2, new int[]{}, new Texture("halifax3.png"), new Pixmap(Gdx.files.internal("halifax3.png")), "halifax3.png", 0, 0, false));
        this.sectors.put(7, new Sector(7, -1, "Halifax 4", 0, 2, new int[]{}, new Texture("halifax4.png"), new Pixmap(Gdx.files.internal("halifax4.png")), "halifax4.png", 0, 0, false));

        // derwent
        this.sectors.put(8, new Sector(8, -1, "Derwent 1", 0, 2, new int[]{}, new Texture("derwent1.png"), new Pixmap(Gdx.files.internal("derwent1.png")), "derwent1.png", 0, 0, false));
        this.sectors.put(9, new Sector(9, -1, "Derwent 2", 0, 2, new int[]{}, new Texture("derwent2.png"), new Pixmap(Gdx.files.internal("derwent2.png")), "derwent2.png", 0, 0, false));
        this.sectors.put(10, new Sector(10, -1, "Derwent 3", 0, 2, new int[]{}, new Texture("derwent3.png"), new Pixmap(Gdx.files.internal("derwent3.png")), "derwent3.png", 0, 0, false));
        this.sectors.put(11, new Sector(11, -1, "Derwent 4", 0, 2, new int[]{}, new Texture("derwent4.png"), new Pixmap(Gdx.files.internal("derwent4.png")), "derwent4.png", 0, 0, false));

        // alcuin
        this.sectors.put(12, new Sector(12, -1, "Alcuin 1", 0, 2, new int[]{}, new Texture("alcuin1.png"), new Pixmap(Gdx.files.internal("alcuin1.png")), "alcuin1.png", 0, 0, false));
        this.sectors.put(13, new Sector(13, -1, "Alcuin 2", 0, 2, new int[]{}, new Texture("alcuin2.png"), new Pixmap(Gdx.files.internal("alcuin2.png")), "alcuin2.png", 0, 0, false));
        this.sectors.put(14, new Sector(14, -1, "Alcuin 3", 0, 2, new int[]{}, new Texture("alcuin3.png"), new Pixmap(Gdx.files.internal("alcuin3.png")), "alcuin3.png", 0, 0, false));

        // vanburgh
        this.sectors.put(15, new Sector(15, -1, "Vanburgh 1", 0, 2, new int[]{}, new Texture("vanbrugh1.png"), new Pixmap(Gdx.files.internal("vanbrugh1.png")), "vanbrugh1.png", 0, 0, false));
        this.sectors.put(16, new Sector(16, -1, "Vanburgh 2", 0, 2, new int[]{}, new Texture("vanbrugh2.png"), new Pixmap(Gdx.files.internal("vanbrugh2.png")), "vanbrugh2.png", 0, 0, false));
        this.sectors.put(17, new Sector(17, -1, "Vanburgh 3", 0, 2, new int[]{}, new Texture("vanbrugh3.png"), new Pixmap(Gdx.files.internal("vanbrugh3.png")), "vanbrugh3.png", 0, 0, false));
        this.sectors.put(18, new Sector(18, -1, "Vanburgh 4", 0, 2, new int[]{}, new Texture("vanbrugh4.png"), new Pixmap(Gdx.files.internal("vanbrugh4.png")), "vanbrugh4.png", 0, 0, false));

        // wentworth
        this.sectors.put(19, new Sector(19, -1, "Wentworth 1", 0, 2, new int[]{}, new Texture("wentworth1.png"), new Pixmap(Gdx.files.internal("wentworth1.png")), "wentworth1.png", 0, 0, false));
        this.sectors.put(20, new Sector(20, -1, "Wentworth 2", 0, 2, new int[]{}, new Texture("wentworth2.png"), new Pixmap(Gdx.files.internal("wentworth2.png")), "wentworth2.png", 0, 0, false));

        // james
        this.sectors.put(21, new Sector(21, -1, "James 1", 0, 2, new int[]{}, new Texture("james1.png"), new Pixmap(Gdx.files.internal("james1.png")), "james1.png", 0, 0, false));
        this.sectors.put(22, new Sector(22, -1, "James 2", 0, 2, new int[]{}, new Texture("james2.png"), new Pixmap(Gdx.files.internal("james2.png")), "james2.png", 0, 0, false));
        this.sectors.put(23, new Sector(23, -1, "James 3", 0, 2, new int[]{}, new Texture("james3.png"), new Pixmap(Gdx.files.internal("james3.png")), "james3.png", 0, 0, false));
        this.sectors.put(24, new Sector(24, -1, "James 4", 0, 2, new int[]{}, new Texture("james4.png"), new Pixmap(Gdx.files.internal("james4.png")), "james4.png", 0, 0, false));

        //neutral
        this.sectors.put(25, new Sector(25, -1, "Neutral 1", 0, 2, new int[]{}, new Texture("neutral1.png"), new Pixmap(Gdx.files.internal("neutral1.png")), "neutral1.png", 0, 0, false));
        this.sectors.put(26, new Sector(26, -1, "Neutral 2", 0, 2, new int[]{}, new Texture("neutral2.png"), new Pixmap(Gdx.files.internal("neutral2.png")), "neutral2.png", 0, 0, false));
        this.sectors.put(27, new Sector(27, -1, "Neutral 3", 0, 2, new int[]{}, new Texture("neutral3.png"), new Pixmap(Gdx.files.internal("neutral3.png")), "neutral3.png", 0, 0, false));
        this.sectors.put(28, new Sector(28, -1, "Neutral 4", 0, 2, new int[]{}, new Texture("neutral4.png"), new Pixmap(Gdx.files.internal("neutral4.png")), "neutral4.png", 0, 0, false));
        this.sectors.put(29, new Sector(29, -1, "Neutral 5", 0, 2, new int[]{}, new Texture("neutral5.png"), new Pixmap(Gdx.files.internal("neutral5.png")), "neutral5.png", 0, 0, false));
        this.sectors.put(30, new Sector(30, -1, "Neutral 6", 0, 2, new int[]{}, new Texture("neutral6.png"), new Pixmap(Gdx.files.internal("neutral6.png")), "neutral6.png", 0, 0, false));
